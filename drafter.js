...
if (typeof jQuery === 'undefined') {
	...
	var civData = {
		...
		"America": { tags: ["vanilla", "seasonal"], displayName: "America" },
		"Arabia": { tags: ["vanilla"], displayName: "Arabia" },
		"Argentina": { tags: ["modded", "seasonal"], displayName: "Argentina" },
		"Armenia": { tags: ["modded", "seasonal"], displayName: "Armenia" },
		...
		"Chile": { tags: ["modded", "coastal", "seasonal"], displayName: "Chile" },
		"China": { tags: ["vanilla"], displayName: "China" },
		"Colombia": { tags: ["modded", "seasonal"], displayName: "Colombia" },
		...
		"Georgia": { tags: ["modded", "seasonal"], displayName: "Georgia" },
		...
		"Huns": { tags: ["vanilla", "seasonal"], displayName: "Huns" },
		...
		"Japan": { tags: ["vanilla", "coastal", "seasonal"], displayName: "Japan" },
		"Jerusalem": { tags: ["modded", "seasonal"], displayName: "Jerusalem" },
		"Khmer": { tags: ["modded", "seasonal"], displayName: "Khmer" },
		...
		"Macedonian": { tags: ["modded", "seasonal"], displayName: "Macedonia" },
		...
		"Maya": { tags: ["vanilla", "seasonal"], displayName: "Maya" },
		...
		"NewZealand": { tags: ["modded", "coastal", "seasonal"], displayName: "New Zealand" },
		...
		"Nubia": { tags: ["modded", "seasonal"], displayName: "Nubia" },
		...
		"Philippines": { tags: ["modded", "coastal", "seasonal"], displayName: "Philippines" },
		...
		"Sioux": { tags: ["modded", "seasonal"], displayName: "Sioux" },
		"Songhai": { tags: ["vanilla"], displayName: "Songhai" },
		"Spain": { tags: ["vanilla", "coastal", "seasonal"], displayName: "Spain" },
